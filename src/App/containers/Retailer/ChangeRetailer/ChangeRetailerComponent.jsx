...
import { OrderDetails } from "../ChangeRetailer/components/orderDetails";
...
const ChangeRetailerComponent = (props) => {
  useEffect(() => {
    console.log("ChangeRetailerComponent");
    console.dir(props);
  }, []);
  ...
  return (
    <Card className={classes.ChangeRetailerComponent} variant="outlined">
      <CardContent p={2}>
        <OrderDetails {...props} />
